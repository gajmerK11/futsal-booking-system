    ...
    <DashboardLayout>
      <main className="p-8">
        ...
        <section className="mt-8">
          ...
          <div className="flex flex-col border-2 rounded-3xl border-dashed border-outline-variant items-center p-10 bg-surface-container-low gap-4 min-h-[300px] justify-center">
            ...
            <button className="bg-primary text-white px-10 py-3 rounded-full text-xs font-semibold tracking-widest hover:bg-primary-container flex items-center gap-2 cursor-pointer">
